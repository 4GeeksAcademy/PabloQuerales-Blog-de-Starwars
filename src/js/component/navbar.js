...
export const Navbar = () => {
	...
	return (
		<nav className="navbar navbar-light bg-light p-0">
			<Link to="/">
				<img src="https://cdn.freebiesupply.com/logos/large/2x/star-wars-logo-png-transparent.png" style={{ width: "7rem" }} className="navbar-brand mx-5 p-0" />
			</Link>
			<div className="dropdown mx-5">
				<button className="btn btn-secondary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
					Favoritos <span>{store.favoriteArray.length}</span>
				</button>
